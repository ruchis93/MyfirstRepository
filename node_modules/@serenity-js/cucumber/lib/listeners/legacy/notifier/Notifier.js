...
class Notifier {
    ...
    stepStarts(step) {
        ...
        this.emit(new events_1.TaskStarts(this.currentSceneId, this.currentStepActivityId, new model_1.ActivityDetails(step.name, step.location), this.serenity.currentTime()));
    }
