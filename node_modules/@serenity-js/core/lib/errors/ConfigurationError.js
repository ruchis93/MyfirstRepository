 ...
 * @group Errors
 */
class ConfigurationError extends RuntimeError_1.RuntimeError {
    static fromJSON(serialised) {
        const error = new ConfigurationError(serialised.message, ErrorSerialiser_1.ErrorSerialiser.deserialise(serialised.cause));
