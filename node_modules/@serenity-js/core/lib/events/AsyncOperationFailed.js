...
class AsyncOperationFailed extends DomainEvent_1.DomainEvent {
    static fromJSON(o) {
        return new AsyncOperationFailed(errors_1.ErrorSerialiser.deserialise(o.error), model_1.CorrelationId.fromJSON(o.correlationId), model_1.Timestamp.fromJSON(o.timestamp));
    }
