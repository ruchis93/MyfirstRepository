...
class AsyncOperationAttempted extends DomainEvent_1.DomainEvent {
    static fromJSON(o) {
        return new AsyncOperationAttempted(model_1.Name.fromJSON(o.name), model_1.Description.fromJSON(o.description), model_1.CorrelationId.fromJSON(o.correlationId), model_1.Timestamp.fromJSON(o.timestamp));
    }
