...
class ActivityRelatedArtifactGenerated extends ArtifactGenerated_1.ArtifactGenerated {
    static fromJSON(o) {
        return new ActivityRelatedArtifactGenerated(model_1.CorrelationId.fromJSON(o.sceneId), model_1.CorrelationId.fromJSON(o.activityId), model_1.Name.fromJSON(o.name), model_1.Artifact.fromJSON(o.artifact), model_1.Timestamp.fromJSON(o.timestamp));
    }
