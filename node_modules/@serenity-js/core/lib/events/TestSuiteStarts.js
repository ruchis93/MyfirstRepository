 ...
 * @group Events
 */
class TestSuiteStarts extends DomainEvent_1.DomainEvent {
    static fromJSON(o) {
        return new TestSuiteStarts(model_1.TestSuiteDetails.fromJSON(o.details), model_1.Timestamp.fromJSON(o.timestamp));
    }
